...
export default function CFPModal({ isOpen, onClose, onStartSubmission }) {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm overflow-hidden">
      <div className="bg-white w-full max-w-[950px] rounded-[2rem] shadow-2xl overflow-hidden relative flex flex-col animate-in fade-in zoom-in duration-300 max-h-[95vh] my-auto">
        {/* --- BRANDED FIXED HEADER --- */}
        <div className="w-full bg-[#003366] p-4 md:p-5 flex items-center justify-between border-b border-white/10 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h2 className="text-white font-black text-base md:text-lg leading-none tracking-tight uppercase">
                CONFERENCE <span className="text-[#C5A059]">DBA</span>
              </h2>
              <span className="text-white/60 text-[9px] md:text-[10px] tracking-[0.2em] mt-1 font-medium uppercase">
                INTERNATIONAL 2026
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row overflow-y-auto custom-scrollbar">
          ...
          <div className="w-full md:w-5/12 bg-[#003366] p-8 md:p-12 text-white flex flex-col justify-between border-r border-white/5 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-4 bg-white/5 border border-white/10 p-4 rounded-2xl mb-8 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold">PDF (300 Word Abstract)</p>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-[#C5A059] text-[#003366] py-4 rounded-xl font-black uppercase tracking-widest text-xs flex items-center justify-center gap-2 hover:bg-white transition-all shadow-xl active:scale-95 relative z-10"
            >
          ...
          <div className="w-full md:w-7/12 p-8 md:p-12 bg-white flex flex-col justify-center">
            <div className="mb-8 text-center md:text-left">
              ...
              <p className="text-slate-500 text-xs font-medium mt-1 uppercase tracking-wider italic">
