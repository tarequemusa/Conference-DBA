  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div
        ...
        } rounded-[2rem] shadow-2xl overflow-hidden relative flex flex-col md:flex-row animate-in fade-in zoom-in duration-300`}
      >
        <button
          onClick={onClose}
        ...
        {legalView && (
          <div className="absolute inset-0 z-[120] bg-[#003366] text-white p-10 md:p-16 animate-in slide-in-from-bottom duration-500 flex flex-col justify-center">
            <div className="absolute top-8 right-16 flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md">
            ...
            <button
              ...
              className="absolute top-8 left-8 flex items-center gap-2 text-[#C5A059] font-black text-[10px] uppercase tracking-widest hover:text-white transition-colors"
            >
              <ChevronLeft size={16} /> Back to Register
            </button>

            <div className="max-w-xl mx-auto md:mx-0">
              <div className="w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center text-[#C5A059] mb-8 shadow-xl">
                {legalView === "privacy" ? (
                  <ShieldCheck size={32} />
                ) : (
                  <Scale size={32} />
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center gap-6">
                <button
                  ...
                  className="bg-[#C5A059] text-[#003366] px-10 py-4 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-white transition-all shadow-2xl active:scale-95"
                >
                  I Understand & Agree
                </button>

                {/* --- ADDED LINK TO LEGAL PAGE --- */}
                <Link
                  href="/legal"
                  target="_blank"
                  className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[#C5A059] hover:text-white transition-colors group"
                >
        ...
        {view === "signup" && (
          <div className="md:w-5/12 bg-[#003366] p-12 text-white flex flex-col justify-between animate-in slide-in-from-left duration-500">
            <div>
            ...
            <ul className="space-y-5 my-8 md:my-0">
              {[
            ...
            <p className="text-[10px] text-slate-400 italic uppercase tracking-widest font-bold">
        ...
        <div
          className={`${view === "signup" ? "md:w-7/12" : "w-full"} p-10 md:p-12 bg-white`}
        >
          {isEmailSent ? (
            ...
            <>
              <div className="mb-8 text-center md:text-left">
                {view === "forgot" && (
                  <button
                    ...
                    className="flex items-center gap-1 text-xs font-bold text-[#C5A059] uppercase tracking-widest mb-4 hover:text-[#003366] transition-colors"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {view === "signup" && (
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#C5A059] outline-none transition-all"
                      onChange={(e) =>
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-xl font-bold shadow-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50 active:scale-[0.98] ${
                    view === "signup"
