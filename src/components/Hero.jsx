        ...
        <div className="max-w-6xl mx-auto text-center text-white flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 mb-8 animate-in fade-in slide-in-from-top-4 duration-1000">
            ...
            <div className="flex flex-col items-center md:items-end md:border-r md:border-white/20 md:pr-8">
              <h3 className="text-[#C5A059] text-[11px] md:text-[13px] font-black uppercase tracking-[0.3em] leading-tight">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 bg-white/5 backdrop-blur-xl border border-white/10 p-4 md:p-6 rounded-[2rem] shadow-2xl">
              <div className="flex items-center gap-3 px-4 border-r border-white/10">
                ...
                <div className="text-left">
                  <p className="text-[0.5rem] font-black text-[#C5A059] uppercase tracking-widest leading-none mb-1">
                    Conference Date
                  </p>
                  <p className="text-[0.875rem] md:text-[1rem] font-bold text-white leading-none">
                    18th-19th Dec 2026
                  </p>
                </div>
              </div>
  ...
  return (
    <div className="flex gap-4 items-center">
      <div className="text-center">
        <p className="text-[0.5rem] font-black text-[#C5A059] uppercase tracking-widest mb-1">
          Time to Event
        </p>
...
function TimeBox({ val, unit }) {
  return (
    <div className="bg-white/10 border border-white/5 rounded-lg px-2 py-1 min-w-[2.5rem]">
      <p className="text-[0.875rem] font-black text-white leading-none">
        {val.toString().padStart(2, "0")}
      </p>
      <p className="text-[0.4375rem] font-bold text-[#C5A059] uppercase">
        {unit}
      </p>
    </div>
  );
