    ...
    <div className="relative min-h-screen w-full overflow-hidden flex items-center justify-center bg-black">
      ...
      <div className="relative z-10 w-full pt-20 pb-10 px-6">
        <div className="max-w-6xl mx-auto text-center text-white flex flex-col items-center">
          ...
          {/* Main Title - Fixed Font Black */}
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tighter uppercase mb-6 animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          <div className="inline-block px-4 py-1.5 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto px-4">
            ...
            {session ? (
              <button
                ...
                className="flex items-center justify-center gap-2 bg-[#C5A059] text-[#003366] px-8 py-4 rounded-xl font-black uppercase text-[11px] tracking-widest shadow-xl hover:bg-white transition-all duration-300 active:scale-95 shadow-[#C5A059]/20"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-[#C5A059] text-[#003366] px-10 py-4 rounded-xl font-black uppercase text-[11px] tracking-widest shadow-2xl hover:bg-white transition-all duration-300 active:scale-95 shadow-[#C5A059]/40"
              >
      ...
      {/* Global CSS for the Slow Zoom effect */}
      <style jsx global>{`
        @keyframes slow-zoom {
          from {
            transform: scale(1);
